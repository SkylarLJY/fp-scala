...
class AnagramsSuite extends munit.FunSuite:
  ...
  test("empty sentence occurrences") {
  ...
  test("short sentence: a"){
   ...
   test("short sentence: i a"){
    val sentence = List("ia")
    val anas = List(
     List("I", "a"),
     List("a", "I")
    )
  ...
  test("short sentence: I am"){
    val sentence = List("I", "am")
    val anas = List(
      List("I", "am"),
      List("am", "I"),
      List("aim")
